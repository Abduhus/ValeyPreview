...
// List of Bvlgari image files to remove (these don't match product names)
const bvlgariImagesToRemove = [
  // All the bvlgari_le_gemme images we created that don't match specific product names
...
console.log('=== REMOVING MISMATCHED BVLGARI IMAGES ===\n');
...
console.log(`Only the mismatched image files have been removed.`);
